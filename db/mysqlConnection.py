...
class Config(object):
    ...
    def __init__(self, config_filename="dbConnection.cnf"):
...
def test():
    mysql = MyPymysqlPool("mysqlConfig")

    sqlAll = "select * from data_spider.testscore"
    result = mysql.getAll(sqlAll)
    # print(len(result))

    sql2 = "select * from data_spider.testscore where id=%s"
    param2 = ["2"]
    ...
    param3.append(3)
    param3.append(5)
    sql3 = "select * from data_spider.testscore where id in (%s,%s)"
...
#     pass
#     mysql = MyPymysqlPool("testdb")
#     param3 = []
#     param3.append(19)
#     param3.append(20)
#     sql3 = "select id,title,imgs from yidian.y_substance where id in (%s,%s)"
#     result2 = mysql.getAll(sql3, param3)
#     print(result2)